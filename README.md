...
В модулях `masks` и `utils` создано логирование работы функций.
Данные о работе перезаписываются каждый раз после запуска программы 
в папку `logs` в файл с именем,
соответствующим названию модуля.
